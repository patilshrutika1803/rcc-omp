...
export function EmptyState({ onAdd, onResetFilters }: { onAdd: () => void; onResetFilters?: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <div className="flex gap-3">
          <button onClick={onResetFilters} className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-600 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
