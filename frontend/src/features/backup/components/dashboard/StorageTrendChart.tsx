...
import type { StorageTrendPoint } from "../../types/backup";

export function StorageTrendChart({ storageTrend }: { storageTrend: StorageTrendPoint[] }) {
  return (
      ...
      <div className="h-[200px]">
        {storageTrend.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={storageTrend} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
              <defs>
